        ...
        Container(
          ...
          child: Row(
            children: [
              GestureDetector(
                onTap: () {
                  final request = UpdateCartRequest(id: id, isIncrease: false);
                  ref
              ...
              GestureDetector(
                onTap: () {
                  final request = UpdateCartRequest(id: id, isIncrease: true);
                  ref
                      .read(cartNotifierProvider.notifier)
                      .updateCartItem(request);
                },
    ...
    case CartEmpty():
      return Center(
          child: TextHelper.textFormat16(
              text: 'Cart is empty\nPlease add something from menu!',
              color: Colors.black,
              isBold: true));
  }
}
        ...
        child: Column(
          ...
          children: [
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                TextHelper.textFormat16(text: "Subtotal", color: Colors.black),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                TextHelper.textFormat16(text: "Tax (5%)", color: Colors.black),
